...
DATA_ARGS='--batch_size 16 --num_workers 16 --input_type rest --project_name abcd2god_ft_dx_0.5train_mae_mamba_ratio0.5 --limit_training_samples 0.5'
OPTIONAL_ARGS='--c_multiplier 2 --last_layer_full_MSA True --downstream_task classification --downstream_task_type classification'
RESUME_ARGS='--load_model_path ./output/abcd_mae_mamba_ratio0.5/checkpt-epoch=37-valid_loss=0.37.ckpt --num_classes 150'
