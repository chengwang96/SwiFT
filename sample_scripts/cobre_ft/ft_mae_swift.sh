...
DATA_ARGS='--batch_size 8 --num_workers 8 --input_type rest --project_name abcd2cobre_ft_dx_mae_swift_ratio0.5'
OPTIONAL_ARGS='--c_multiplier 2 --last_layer_full_MSA True --downstream_task dx --downstream_task_type classification'
RESUME_ARGS='--load_model_path ./output/abcd_mae_swift_ratio0.5/checkpt-epoch=22-valid_loss=0.47.ckpt --num_classes 4'
