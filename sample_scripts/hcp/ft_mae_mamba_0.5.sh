...
DATA_ARGS='--batch_size 32 --num_workers 32 --input_type rest --project_name abcd2hcp_ft_CogTotalComp_AgeAdj_0.5train_mae_mamba_ratio0.5 --limit_training_samples 0.5'
