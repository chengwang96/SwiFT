...
DATA_ARGS='--batch_size 16 --num_workers 16 --input_type rest --project_name abcd2hcp_ft_CogTotalComp_AgeAdj_1.0train_mae_mamba_ratio0.5 --limit_training_samples 1.0'
