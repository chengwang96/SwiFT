...
MAIN_ARGS='--loggername tensorboard --clf_head_version v3 --dataset_name ADHD200 --image_path ./data/fmri/ADHD200_MNI_to_TRs_minmax'
DATA_ARGS='--batch_size 8 --num_workers 8 --input_type rest --project_name adhd_dx_swift'
