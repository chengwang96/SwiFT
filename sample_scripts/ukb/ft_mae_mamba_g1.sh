...
MAIN_ARGS='--loggername tensorboard --clf_head_version v3 --dataset_name S1200 --image_path /data/share_142/cwang/fmri/HCP1200_MNI_to_TRs_minmax'
DATA_ARGS='--batch_size 32 --num_workers 32 --input_type rest --project_name abcd2hcp_ft_mae_mamba_ratio0.5'
OPTIONAL_ARGS='--c_multiplier 2 --last_layer_full_MSA True --downstream_task int_total'
RESUME_ARGS='--load_model_path ./output/abcd_mae_mamba_ratio0.5/checkpt-epoch=09-valid_loss=0.74.ckpt'
