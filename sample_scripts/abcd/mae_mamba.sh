...
DATA_ARGS='--batch_size 12 --num_workers 12 --input_type rest --project_name abcd_mae_mamba_ratio0.8'
OPTIONAL_ARGS='--c_multiplier 2 --last_layer_full_MSA True --downstream_task sex'
RESUME_ARGS='--pretraining --use_mae --spatial_mask window --time_mask random --mask_ratio 0.8'
# --resume_ckpt_path ./output/abcd_mae_mamba_ratio0.8/checkpt-epoch=22-valid_loss=0.45.ckpt
