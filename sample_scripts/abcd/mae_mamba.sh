TRAINER_ARGS='--accelerator gpu --max_epochs 40 --precision 32 --num_nodes 1 --devices 4 --strategy DDP'
MAIN_ARGS='--loggername tensorboard --classifier_module v6 --dataset_name ABCD --image_path ./data/ABCD_MNI_to_TRs_minmax'
DATA_ARGS='--batch_size 12 --num_workers 12 --input_type rest --project_name abcd_mae_mamba_ratio0.5'
