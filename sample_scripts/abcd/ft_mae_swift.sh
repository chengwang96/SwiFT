...
DATA_ARGS='--batch_size 8 --num_workers 8 --input_type rest --project_name abcd2hcp_ft_mae_swift_ratio0.6'
OPTIONAL_ARGS='--c_multiplier 2 --last_layer_full_MSA True --downstream_task int_total'
RESUME_ARGS='--load_model_path ./output/abcd_mae_swift_ratio0.5/checkpt-epoch=22-valid_loss=0.47.ckpt'
